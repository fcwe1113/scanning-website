...
export const setPaymentSuccess = new referenceObj(null)
export const toastPaymentError = new referenceObj(() => {})
export const setPaymentTransfer = new referenceObj(null)